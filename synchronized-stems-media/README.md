...
mesh, and Nexus adapters must supply real capability facts. They must also
supply key-epoch AEAD and the selected FEC implementation. These components are
necessary before this becomes a live path.
